...
seeding_tracks = make_seeding_tracks(
    decoded_scifi,
    seeding_xz_tracks,
    scifi_consolidate_seeds_name="velo_scifi_matching_sequence_scifi_consolidate_seeds",
)
...
matched_tracks = make_velo_scifi_matches(
    ...
    seeding_tracks,
    ut_hits=ut_hits,
    matching_consolidate_tracks_name="velo_scifi_matching_sequence_matching_consolidate_tracks",
)
velo_scifi = long_validation(matched_tracks)
velo_scifi_matching_sequence = CompositeNode(
    "Validators",
    [
        CompositeNode("veloValidation", [velo], NodeLogic.LAZY_AND, force_order=True),
        CompositeNode(
            "veloSciFiDump",
        ...
        CompositeNode(
            "veloSciFiValidation", [velo_scifi], NodeLogic.LAZY_AND, force_order=True
        ),
    ],
