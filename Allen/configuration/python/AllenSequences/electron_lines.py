...
reconstructed_objects = hlt1_reconstruction(
    with_muon=True, with_calo=True, tracking_type=TrackingType.FORWARD_THEN_MATCHING
)
...
for subSample in ["NoIP", "NoIPNorm", "Displaced"]:
    common_kwargs_low_mass_electron = {
        ...
        else 2,  # it will only be picked up by the displaced line the NoIP (aka prompt) won't trigger this cut
