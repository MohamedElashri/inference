...
def veloUT_validation(veloUT_tracks, name="veloUT_validator"):
    ...
    return make_algorithm(
        ...
        dev_velo_track_hits_t=velo_tracks["dev_velo_track_hits"],
        host_mc_events_t=mc_events.host_mc_events_t,
        dev_velo_kalman_endvelo_states_t=velo_states["dev_velo_kalman_endvelo_states"],
...
def downstream_validation(
    downstream_tracks, name="downstream_validator", with_downstream_KF=False
):
    mc_events = mc_data_provider()
    number_of_events = initialize_number_of_events()
...
def seeding_xz_validation(name="seed_xz_validator"):
    ...
    seeding_copy_trackXZ_hit_number = make_algorithm(
        ...
        dev_seed_xz_number_of_tracks_t=seeding_tracks["seed_xz_number_of_tracks"],
    ...
    return make_algorithm(
        ...
        name=name,
        host_number_of_events_t=number_of_events["host_number_of_events"],
        dev_offsets_scifi_seedsXZ_t=seeding_copy_trackXZ_hit_number.dev_offsets_scifi_seedsXZ_t,
        dev_scifi_hits_t=decoded_scifi["dev_scifi_hits"],
        dev_scifi_hit_count_t=decoded_scifi["dev_scifi_hit_offsets"],
        dev_offsets_scifi_seedXZ_hit_number_t=seeding_copy_trackXZ_hit_number.dev_offsets_scifi_seedXZ_hit_number_t,
...
def seeding_unmatched_validation(
    seeding_tracks, velo_scifi_matches, name="unmached_seed_validator"
):
    mc_events = mc_data_provider()
...
def velo_scifi_dump(matched_tracks, name="veloscifi_dump"):
    ...
    return make_algorithm(
        ...
        dev_ut_selected_velo_tracks_t=matched_tracks["dev_ut_selected_velo_tracks"],
        dev_offsets_scifi_seeds_t=seeding_tracks["dev_offsets_scifi_seeds"],
        dev_scifi_hits_t=seeding_tracks["dev_seeding_track_hits"],
        dev_offsets_scifi_seed_hit_number_t=seeding_tracks[
            "dev_offsets_scifi_seed_hit_number"
...
def downstream_kalman_validation(
    downstream_tracks, pvs, name="downstream_kalman_validator"
):
    number_of_events = initialize_number_of_events()
    mc_events = mc_data_provider()
    ...
    return make_algorithm(
        ...
        dev_downstream_kf_tracks_t=downstream_tracks["dev_downstream_kf_tracks"],
...
def selreport_validation(
    make_selreports, gather_selections, name="selreport_validator"
):
    number_of_events = initialize_number_of_events()
