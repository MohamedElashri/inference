...
def make_cone_jets(long_tracks, long_track_particles, ecal_clusters, n_max_jets=8):
    ...
    make_jet_particles = make_algorithm(
        ...
        host_number_of_events_t=number_of_events["host_number_of_events"],
        host_number_of_neutral_clusters_t=build_cone_jets.host_number_of_jets_t,
        dev_number_of_events_t=number_of_events["dev_number_of_events"],
    ...
    return {
        "host_number_of_jets": build_cone_jets.host_number_of_jets_t,
        "dev_multi_event_jets": make_jet_particles.dev_multi_event_neutral_particles_view_t,
    }
