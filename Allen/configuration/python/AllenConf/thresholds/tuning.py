...
threshold_settings = Thresholds(
    ...
    TrackElectronMVA_NN=0.,
    TrackMuonMVA_NN=0.,
    DiMuonHighMass_NN=0.,
    DiElectronDisplaced_NN=0.,
    DiMuonDisplaced_NN=0.,
    DiMuonDisplacedSoftPT_NN=0.,
    DiMuonNoIP_NN=0.,
    DownstreamKsToPiPi_minMVA_detached=0.55,
    DownstreamLambdaToPPi_minMVA_detached=0.5,
    DownstreamTwoTrackKs_minPt=475.,  # not used
    DiProtonHighMass_P_minPt=5000.,
    DiProtonHighMass_PP_minPt=6000.,
    DownstreamGammaToEE_minPt=1000.,
    DownstreamTwoTrackKs_minTrackPt_piKs=475.,
    DiElectronLowMassNoIP_NN=0.,
    DiElectronLowMass_NN=0.)
