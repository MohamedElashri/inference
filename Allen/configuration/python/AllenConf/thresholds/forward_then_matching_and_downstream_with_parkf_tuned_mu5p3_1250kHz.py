...
threshold_settings = Thresholds(
    ...
    TrackElectronMVA_alpha=1320,
    TrackMuonMVA_alpha=-1130,
    D2HH_track_ip=0.09,
    D2HH_track_pt=700,
    D2HH_ctIPScale=1.0,
    SingleHighPtLepton_pt=12500,
    SingleHighPtLepton_pt_noMuonID=12500,
    TwoTrackMVA_minMVA=0.9675,
    ...
    DiMuonHighMass_pt=750,
    DiMuonDisplaced_pt=200,
    DiMuonDisplaced_ipchi2=6.08,
    DiElectronDisplaced_pt=380,
    DiElectronDisplaced_ipchi2=6.96,
    DiPhotonHighMass_minET=2700,
