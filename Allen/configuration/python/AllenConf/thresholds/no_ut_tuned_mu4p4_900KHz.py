...
threshold_settings = Thresholds(
    ...
    LambdaLLDetachedTrack_combination_bpvfd=46,
    LambdaLLDetachedTrack_track_mipchi2=27,
    SingleHighPtLepton_pt=12500,
    SingleHighPtLepton_pt_noMuonID=12500,
    TrackElectronMVA_alpha=820,
    TrackMVA_alpha=120,
    TrackMVA_maxGhostProb=0.7,
    TrackMuonMVA_alpha=-760,
    ...
    TwoTrackMVA_maxGhostProb=0.7,
    TwoTrackMVA_minMVA=0.966,
