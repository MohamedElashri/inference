...
@configurable
def make_downstream_kshort_line(
    downstream_tracks,
    ...
    return make_algorithm(
        ...
        dev_downstream_mva_ks_t=downstream_secondary_vertices["dev_downstream_mva_ks"],
        dev_downstream_mva_detached_ks_t=downstream_secondary_vertices[
            "dev_downstream_mva_detached_ks"
        ],
        host_number_of_events_t=number_of_events["host_number_of_events"],
        host_number_of_svs_t=downstream_secondary_vertices["host_number_of_svs"],
...
@configurable
def make_downstream_lambda_line(
    downstream_tracks,
    downstream_secondary_vertices,
    pre_scaler_hash_string=None,
    post_scaler_hash_string=None,
    ...
    return make_algorithm(
        ...
        enable_monitoring=is_allen_standalone() and enable_monitoring,
        dev_downstream_mva_l0_t=downstream_secondary_vertices["dev_downstream_mva_l0"],
...
@configurable
def make_downstream_gamma_line(
    downstream_tracks,
    downstream_secondary_vertices,
    pre_scaler_hash_string=None,
    post_scaler_hash_string=None,
...
def make_BuSca_line(
    ...
    busca_mva = downstream_secondary_vertices["dev_downstream_mva_combined_busca"]
...
@configurable
def make_downstream_two_track_ks_line(
    downstream_tracks,
    downstream_vertices,
    pre_scaler_hash_string=None,
    post_scaler_hash_string=None,
    ...
    return make_algorithm(
        ...
        dev_particle_container_t=downstream_vertices["dev_multi_event_composites"],
        pre_scaler_hash_string=pre_scaler_hash_string or name + "_pre",
        post_scaler_hash_string=post_scaler_hash_string or name + "_post",
