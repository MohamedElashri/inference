...
def decode_calo(empty_banks=False):
    ...
    ecal_banks = make_algorithm(
        data_provider_t, name="ecal_banks_{hash}", bank_type="ECal", empty=empty_banks
    )
    ...
    return {
        "host_ecal_number_of_digits": calo_count_digits.host_total_sum_holder_t,
...
def make_is_electron(
    ...
    return {
        "dev_delta_barycenter": track_digit_selective_matching.dev_delta_barycenter_t,
        "dev_dispersion_x": track_digit_selective_matching.dev_dispersion_x_t,
        "dev_dispersion_y": track_digit_selective_matching.dev_dispersion_y_t,
        "dev_dispersion_xy": track_digit_selective_matching.dev_dispersion_xy_t,
        "dev_track_local_max": track_digit_selective_matching.dev_track_local_max_t,
        "dev_matched_ecal_energy": track_digit_selective_matching.dev_matched_ecal_energy_t,
        "dev_matched_ecal_digits_size": track_digit_selective_matching.dev_matched_ecal_digits_size_t,
        "dev_matched_ecal_digits": track_digit_selective_matching.dev_matched_ecal_digits_t,
        "dev_track_inEcalAcc": track_digit_selective_matching.dev_track_inEcalAcc_t,
        "dev_track_Eop": track_digit_selective_matching.dev_track_Eop_t,
        "dev_track_Eop3x3": track_digit_selective_matching.dev_track_Eop3x3_t,
        "dev_track_isElectron": track_digit_selective_matching.dev_track_isElectron_t,
    }


def make_track_matching(
    decoded_calo,
    velo_tracks,
    velo_states,
    long_tracks,
    ...
    return {
        "dev_region": track_digit_selective_matching.dev_region_t,
        "dev_delta_barycenter": track_digit_selective_matching.dev_delta_barycenter_t,
        "dev_dispersion_x": track_digit_selective_matching.dev_dispersion_x_t,
        "dev_dispersion_y": track_digit_selective_matching.dev_dispersion_y_t,
        "dev_dispersion_xy": track_digit_selective_matching.dev_dispersion_xy_t,
        ...
        "dev_track_Eop3x3": track_digit_selective_matching.dev_track_Eop3x3_t,
        "dev_track_isElectron": track_digit_selective_matching.dev_track_isElectron_t,
        "dev_ecal_digits_isTrackMatched": track_digit_selective_matching.dev_ecal_digits_isTrackMatched_t,
        "dev_brem_E": brem_recovery.dev_brem_E_t,
        "dev_brem_ET": brem_recovery.dev_brem_ET_t,
        "dev_brem_inECALacc": brem_recovery.dev_brem_inECALacc_t,
        "dev_brem_ecal_digits_size": brem_recovery.dev_brem_ecal_digits_size_t,
        "dev_brem_ecal_digits": brem_recovery.dev_brem_ecal_digits_t,
        "dev_ecal_digits_isBremMatched": brem_recovery.dev_ecal_digits_isBremMatched_t,
        "dev_brem_corrected_p": momentum_brem_correction.dev_brem_corrected_p_t,
        "dev_brem_corrected_pt": momentum_brem_correction.dev_brem_corrected_pt_t,
    }
...
def fake_digit_matching(decoded_calo):
    ...
    return {
        "dev_ecal_digits_isTrackMatched": fake_digit_match.dev_ecal_digits_isMatched_t,
        "dev_ecal_digits_isBremMatched": fake_digit_match.dev_ecal_digits_isMatched_t,
    }


@configurable
def make_ecal_clusters(
    decoded_calo,
    ...
    calo_overlap_clusters = make_algorithm(
        ...
        host_ecal_number_of_clusters_t=calo_seed_clusters.host_total_sum_holder_t,
        dev_ecal_digits_t=decoded_calo["dev_ecal_digits"],
        dev_ecal_digits_offsets_t=decoded_calo["dev_ecal_digits_offsets"],
        dev_ecal_seed_clusters_t=calo_seed_clusters.dev_ecal_seed_clusters_t,
        dev_ecal_cluster_offsets_t=calo_seed_clusters.dev_ecal_cluster_offsets_t,
    ...
    make_neutral_particles = make_algorithm(
        ...
        host_number_of_events_t=number_of_events["host_number_of_events"],
        host_number_of_neutral_clusters_t=calo_find_clusters.host_total_sum_holder_t,
        dev_number_of_events_t=number_of_events["dev_number_of_events"],
        dev_ecal_cluster_offsets_t=calo_seed_clusters.dev_ecal_cluster_offsets_t,
        dev_ecal_neutral_cluster_offsets_t=calo_find_clusters.dev_ecal_neutral_cluster_offsets_t,
    ...
    calo_prefilter_clusters = make_algorithm(
        ...
        host_number_of_events_t=number_of_events["host_number_of_events"],
        dev_number_of_events_t=number_of_events["dev_number_of_events"],
        host_ecal_number_of_neutral_clusters_t=calo_find_clusters.host_total_sum_holder_t,
    ...
    calo_filter_clusters = make_algorithm(
        ...
        host_number_of_events_t=number_of_events["host_number_of_events"],
        host_ecal_number_of_twoclusters_t=calo_prefilter_clusters.host_total_sum_holder_t,
        dev_neutral_particles_t=make_neutral_particles.dev_multi_event_neutral_particles_view_t,
        dev_num_prefiltered_clusters_t=calo_prefilter_clusters.dev_num_prefiltered_clusters_t,
        dev_ecal_twocluster_offsets_t=calo_prefilter_clusters.dev_ecal_twocluster_offsets_t,
        dev_prefiltered_clusters_idx_t=calo_prefilter_clusters.dev_prefiltered_clusters_idx_t,
        dev_ecal_cluster_offsets_t=calo_seed_clusters.dev_ecal_cluster_offsets_t,
    )
    ...
    calo_find_twoclusters = make_algorithm(
        ...
        host_number_of_events_t=number_of_events["host_number_of_events"],
        host_number_of_twoclusters_t=calo_prefilter_clusters.host_total_sum_holder_t,
        dev_number_of_events_t=number_of_events["dev_number_of_events"],
        dev_neutral_particles_t=make_neutral_particles.dev_multi_event_neutral_particles_view_t,
    ...
    return {
        "host_ecal_number_of_clusters": calo_seed_clusters.host_total_sum_holder_t,
        "host_ecal_number_of_neutral_particles": calo_find_clusters.host_total_sum_holder_t,
        "host_ecal_number_of_twoclusters": calo_prefilter_clusters.host_total_sum_holder_t,
        "dev_ecal_cluster_offsets": calo_seed_clusters.dev_ecal_cluster_offsets_t,
        "dev_ecal_neutral_particle_offsets": calo_find_clusters.dev_ecal_neutral_cluster_offsets_t,
        "dev_ecal_clusters": calo_find_clusters.dev_ecal_clusters_t,
        "dev_multi_event_neutral_particles": make_neutral_particles.dev_multi_event_neutral_particles_view_t,
        "dev_multi_event_diphotons": calo_find_twoclusters.dev_multi_event_twoclusters_view_t,
    }
