...
def make_odin_event_type_with_decoding_line(
    odin_event_type: str,
    name=None,
    pre_scaler=1.0,
    post_scaler=1.0,
    ...
    return make_algorithm(
        ...
        post_scaler=post_scaler,
        dev_odin_data_t=odin["dev_odin_data"],
        dev_sorted_velo_cluster_container_t=velo["dev_sorted_velo_cluster_container"],
...
@configurable
def make_velo_large_clusters_line(
    velo_tracks,
    velo_states,
...
@configurable
def make_velo_clusters_micro_bias_line(
    decoded_velo,
...
def make_t_cosmic_line(
    ...
    max_chi2Y=134.0,
):  # 95 percentile of chi2Y distribution
    number_of_events = initialize_number_of_events()
...
def make_z_range_materialvertex_seed_line(
    ...
    min_z_materialvertex_seed=-10000000.0,
    max_z_materialvertex_seed=10000000.0,
    pre_scaler=1.0,
    post_scaler=1.0,
    pre_scaler_hash_string=None,
    post_scaler_hash_string=None,
