...
namespace rich_make_pixels_from_pd {
  struct Parameters {
    ...
    DEVICE_OUTPUT(dev_rich_pixels_lpos_t, short2) dev_rich_pixels_lpos;
    DEVICE_OUTPUT(dev_rich_pixels_gpos_t, float3) dev_rich_pixels_gpos;
  };

  struct rich_make_pixels_from_pd_t : public DeviceAlgorithm, Parameters {
