...
namespace rich_validator {
  struct Parameters {
    ...
    DEVICE_INPUT(dev_pid_t, Allen::Rich::ParticleIDType) dev_pid;
    DEVICE_OUTPUT(dev_rich_checker_tracks_t, Checker::Track) dev_rich_checker_tracks;
  };

  struct rich_validator_t : public DeviceAlgorithm, Parameters {
