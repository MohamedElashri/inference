...
\************************************************************************/
#include "ODINEventType.cuh"
#include "Event/ODIN.h"
#include "ODINBank.cuh"

INSTANTIATE_ALGORITHM(odin_eventtype::odin_eventtype_t)

void odin_eventtype::odin_eventtype_t::set_arguments_size(
...
void odin_eventtype::odin_eventtype_t::operator()(
