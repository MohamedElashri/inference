...
namespace Lumi {
  namespace Constants {
    ...
    const std::array<std::string, n_velo_counters> velo_counter_names = {
      "VeloTracks",
      "VeloFiducialTracks",
      "VeloTracksEtaBin0",
      "VeloTracksEtaBin1",
    ...
    const std::array<std::string, n_pv_counters> pv_counter_names = {
      "VeloVertices",
    ...
    const std::array<std::string, n_calo_counters> calo_counter_names = {
      "ECalET",
      "ECalEtot",
      "ECalETOuterTop",
      "ECalETMiddleTop",
