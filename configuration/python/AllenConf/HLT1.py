...
def default_physics_lines(reconstructed_objects, with_calo, with_muon,
    ...
    lines = [
        ...
        make_d2pipi_line(
            ...
            charm_track_pt=thresholds.D2HH_track_pt),
        make_dst_line(
            dstars, name="Hlt1Dst2D0Pi", enable_tupling=enable_tupling),
    ...
    if with_calo:
        ...
        for subSample in ["NoIP", "NoIPNorm", "Displaced"]:
            common_kwargs_low_mass_electron = {
                ...
                True,
                "nnCut":
                thresholds.DiElectronLowMassNoIP_NN
                if subSample == "NoIP" else thresholds.DiElectronLowMass_NN,
                "enable_monitoring":
                True,
                "enable_tupling":
                enable_tupling
...
def setup_hlt1_node(enablePhysics=True,
    ...
    with line_maker.bind(prefilter=odin_err_filter):
        technical_lines += [
            line_maker(
                make_passthrough_line(
                    pre_scaler=passthrough_pre_scaler,
