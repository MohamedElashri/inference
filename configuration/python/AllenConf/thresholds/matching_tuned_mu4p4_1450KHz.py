...
threshold_settings = Thresholds(
    ...
    TrackElectronMVA_alpha=340,
    TrackMVA_alpha=-320,
    TrackMVA_maxGhostProb=0.8,
    TrackMuonMVA_alpha=-780,
    TrackMuonMVA_maxCorrChi2=1.8,
    TwoTrackKs_maxEta_Ks=4.44508,
    TwoTrackKs_minComboPt_Ks=1588.31,
    TwoTrackKs_minTrackIPChi2_piKs=36.0753,
    TwoTrackKs_minTrackPt_piKs=425,
    TwoTrackKs_min_combip=0.497205,
    TwoTrackMVA_maxGhostProb=0.8,
    TwoTrackMVA_minMVA=0.939,
