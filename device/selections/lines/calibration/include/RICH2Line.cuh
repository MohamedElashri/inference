...
namespace rich_2_line {
  ...
  struct rich_2_line_t : public SelectionAlgorithm, Parameters, OneTrackLine<rich_2_line_t, Parameters> {
    ...
    struct DeviceProperties {
      ...
      DeviceProperties(const rich_2_line_t& algo, const Allen::Context&) :
  ...
  private:
    ...
    Allen::Property<std::array<float, 4>> m_minPhi {this, "minPhi", {-2.59, -0.65, 0.55, 2.49}, "minimum azi angle"};
    Allen::Property<std::array<float, 4>> m_maxPhi {this, "maxPhi", {-2.49, -0.55, 0.65, 2.59}, "maximum azi angle"};
  };
