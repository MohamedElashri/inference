...
\************************************************************************/
#include "VeloTrackActivity.cuh"

INSTANTIATE_ALGORITHM(velo_track_activity_filter::velo_track_activity_filter_t)

void velo_track_activity_filter::velo_track_activity_filter_t::set_arguments_size(
